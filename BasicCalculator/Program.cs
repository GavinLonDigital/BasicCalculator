    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            catch (CalculationResultOverflowException ex)
            {
                ...
                WriteExceptionMessageToScreen($"The result of this calulation is greater or smaller than the allowable range for an integer value (i.e. between {Int32.MinValue} and {Int32.MaxValue})");
            }
        ...
        private static void WriteAttemptWarningtoScreen(int count)
        {
